...
'''세 가지 Scaling, Rotation, Translation을 list 형태로 담을 수 있는 클래스'''
'''
세 가지는 공통적으로
reload_val()시 지정한 범위 내의 랜덤한 matrix 생성,
augment()시 입력한 정점들에 augmentation을 적용하여 정점들 & matrix 리턴
'''
class Augmentator:
    ...
    def run(self, mesh_arr):
        ...
        for augmentation in self.augmentation_list:
            mesh_arr, mat = augmentation.augment(mesh_arr)
            mats.append(mat)
